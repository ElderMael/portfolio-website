...
export function Navigation(props: any) {
    ...
    return (
        <nav
            ...
            <a href="#home" className="btn btn-success btn-pill col-lg-2 col-md-1 col-sm-2" onClick={showHome}>
                <span className="icon-nav fas fa-2x fa-home"/>
                <span>Home</span>
            </a>
            <a className="btn btn-outline-success btn-pill col-lg-2 col-md-1 col-sm-2"
