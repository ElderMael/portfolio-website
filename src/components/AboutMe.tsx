      ...
      <div className="about-me card col-sm-5 col-lg-5 text-center animated fadeIn delay-5s">
        ...
        <div className="card-body">
          ...
          <p className="card-text">
            ...
            <p>
              Miguel is an avid video game player and Podcast host. He also enjoys tinkering with
              electronics and mod video game consoles. You can also find him streaming on Twitch
              on any of the previous topics.
            </p>
          </p>
        </div>
